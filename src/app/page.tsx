...
export default function Home() {
  ...
  const { fetchAssets, getAssetWithRetry, revokeAssetUrls, configError } = useImmich();
  ...
  return (
    <main className="relative h-screen w-screen overflow-hidden bg-black">
      ...
      {currentMedia && <MediaRenderer media={currentMedia} isVisible={!isFading} isCurrent={true} videoRef={videoRef} onVideoEnd={advanceToNextAsset} />}
      {nextMedia && <MediaRenderer media={nextMedia} isVisible={false} isCurrent={false} />}
